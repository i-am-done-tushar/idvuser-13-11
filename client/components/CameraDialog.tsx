...
export function CameraDialog({ isOpen, onClose, onSubmit }: CameraDialogProps) {
  ...
  const [frontCaptured, setFrontCaptured] = useState<CapturedImage | null>(null);
          ...
          <div className="flex-1 flex items-center justify-center">
            {cameraError ? (
              <div className="text-white text-center">
                ...
                <div className="text-sm opacity-75">Please check your camera permissions</div>
              </div>
            ) : (
              ...
              <div className="flex w-full h-auto sm:h-[272px] flex-col items-center gap-7 flex-shrink-0">
                <div className="flex h-[272px] flex-col items-start flex-shrink-0 self-stretch">
                  <div className="flex justify-center items-center gap-2 flex-1 self-stretch">
                    <div className={`flex flex-col justify-center items-center gap-2 flex-1 self-stretch rounded-t-lg border-2 ${
                      frontCaptured ? 'border-green-500 bg-green-50' : 'border-dashed border-[#C3C6D4] bg-white'
                    }`}>
                      <div className="flex w-full max-w-[326px] h-auto sm:h-[262px] flex-col justify-center items-center gap-2 p-4">
                        {frontCaptured ? (
                          <div className="flex flex-col items-center gap-2">
                            ...
                            />
                            <div className="text-green-600 font-medium text-sm">✓ Front side captured</div>
                            <button
            ...
            <div className="flex flex-1 min-w-0 h-auto sm:h-[320px] flex-col items-start">
              <div className="flex w-full h-auto sm:h-[272px] flex-col items-center gap-7 flex-shrink-0">
                <div className="flex h-[272px] flex-col items-start flex-shrink-0 self-stretch">
                  <div className="flex justify-center items-center gap-2 flex-1 self-stretch">
                    <div className={`flex flex-col justify-center items-center gap-2 flex-1 self-stretch rounded-t-lg border-2 ${
                      backCaptured ? 'border-green-500 bg-green-50' : 'border-dashed border-[#C3C6D4] bg-white'
                    }`}>
                      <div className="flex w-full max-w-[326px] h-auto sm:h-[262px] flex-col justify-center items-center gap-2 p-4">
                        {backCaptured ? (
                          <div className="flex flex-col items-center gap-2">
                            <img 
                              ...
                              className="max-w-full max-h-32 rounded"
                            />
                            <div className="text-green-600 font-medium text-sm">✓ Back side captured</div>
                            <button
